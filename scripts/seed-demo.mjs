...
await run('employees', async () => {
  employees = await ins('employees', [
    ...
    { name: 'Sarah Chen', email: 'sarah@summitfieldco.com', role: 'Office', user_role: 'Admin', is_admin: true, has_hr_access: true, active: true, phone: '(303) 555-0187', annual_salary: 68000, hourly_rate: null, is_salary: true, is_hourly: false, business_unit: 'Commercial', hire_date: '2020-06-15' },
    { name: 'Carlos Rivera', email: 'carlos@summitfieldco.com', role: 'Field Tech', user_role: 'Team Lead', is_admin: false, has_hr_access: false, active: true, phone: '(303) 555-0203', annual_salary: null, hourly_rate: 38, is_hourly: true, is_salary: false, business_unit: 'Commercial', hire_date: '2021-01-11' },
    { name: 'Tyler Brooks', email: 'tyler@summitfieldco.com', role: 'Field Tech', user_role: 'User', is_admin: false, has_hr_access: false, active: true, phone: '(303) 555-0219', annual_salary: null, hourly_rate: 29, is_hourly: true, is_salary: false, business_unit: 'Commercial', hire_date: '2023-05-02' },
    { name: 'Jordan Lee', email: 'jordan@summitfieldco.com', role: 'Sales', user_role: 'User', is_admin: false, has_hr_access: false, active: true, phone: '(303) 555-0244', annual_salary: null, hourly_rate: 26, is_hourly: true, is_salary: false, business_unit: 'Commercial', hire_date: '2022-09-19' },
