...
export const PROPOSAL_MODES = {
  ...
  interactive: {
    id: 'interactive',
    label: 'Interactive Proposal',
    send: 'Send Interactive Proposal',
    resend: 'Resend Interactive Proposal',
    blurb: 'The full case: annual savings, payback, ROI and charts, as a scrolling web proposal.',
    showsSavings: true,
    showsIncentive: true,
  },
  formal: {
