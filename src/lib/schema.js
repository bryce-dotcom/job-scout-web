...
export const QUERIES = {
  ...
  fleet: '*, assigned_to:employees!assigned_to_id(id, name)',
  fleetMaintenance: '*, fleet:fleet!fleet_id(id, name, vehicle_id)',
  lightingAudits: '*, customer:customers!customer_id(id, name), salesperson:employees!salesperson_id(id, name), utility_provider:utility_providers!utility_provider_id(id, provider_name)',
