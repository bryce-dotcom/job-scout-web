      ...
      <div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '16px' }}>
          {[
            ...
            { icon: Navigation, label: 'Cloverleaf', desc: 'Neighbors mode, or the Neighbors button on any lead card: every parcel within 250, 500 or 1000 ft, nearest first, owners included. Tick the ones worth a knock, add them all as leads, or route them from where you stand. Turn on the Finished jobs overlay to start from any past job, lead or not — imported history included.', color: '#15803d' },
