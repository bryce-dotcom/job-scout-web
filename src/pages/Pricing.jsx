...
const CREW = [
  ...
  { ab: 'DG', name: 'Dougie', role: 'Bid packages & takeoffs',
    hook: "Drop in the buyer's invitation to bid; Dougie reads the schedule, matches every item to your catalog, prices it, and builds the bid in their format — sourced prices redlined until you verify them.",
