      ...
      if (!invoice) {
        ...
        if (invoice?.id) {
          try {
            ...
            await writeInvoiceLines(supabase, jobLines, { companyId, invoiceId: invoice.id, summaryFor: { description: job.job_title, total: jobTotal, manual: job.job_total_source === 'manual' } })
          } catch (err) {
