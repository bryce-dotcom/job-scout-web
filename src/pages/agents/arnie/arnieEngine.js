...
**propose_create** — make a NEW record. Seven kinds: a **lead**, an **appointment** on a lead, a **quote**, a **follow-up** on a quote (see Chasing a quote below), a **diagnosis** (what was wrong and what fixed it — see Diagnose above), a **ticket** (see Filing a ticket below), a **payment** on an invoice (see Recording a payment below — admin only), a **memory** (see Remembering below), and an **expense** (see Logging an expense below). Anyone can use all but the payment.
