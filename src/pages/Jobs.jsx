    ...
    <div style={{ padding: '24px', maxWidth: '100%', overflowX: 'hidden' }}>
      ...
      {showImportExport && (
        <ImportExportModal
          ...
          extraContext="Field service / construction job management data. Map as many columns as possible. Common aliases: job_title=Job Name/Project Name/Work Order, job_id=Job Number/Work Order #/Job #, job_address=Site Address/Service Address/Location, job_city=City, job_state=State/Province, job_zip=ZIP/Postal Code, status=Job Status/Stage, priority=Priority/Urgency, job_type=Type/Service Type, job_category=Category, business_unit=Division/Department, start_date=Start/Begin Date, end_date=End/Completion Date, scheduled_start=Scheduled Start, scheduled_end=Scheduled End, assigned_team=Team/Crew Name, assigned_crew=Crew, crew_size=# Workers/Crew Size, allotted_time_hours=Budgeted Hours/Estimated Hours, estimated_hours=Est Hours, actual_hours=Actual Hours/Hours Worked, contract_amount=Contract Value/Job Amount/Price/Total Price/Revenue, labor_cost=Labor Cost/Labor $, material_cost=Material Cost/Materials $, total_cost=Total Cost/Job Cost, billing_type=Billing Type/Rate Type, hourly_rate=Rate/Hour, po_number=PO/PO #/Purchase Order, permit_number=Permit #, scope_of_work=Scope/SOW/Description, details=Details/Job Details, notes=Notes/Comments, internal_notes=Internal Notes/Private Notes"
