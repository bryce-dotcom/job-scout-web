...
const UTAH_BENCHMARK = {
  ...
  forms: [
    ...
    { provider_name: "Rocky Mountain Power", program_name: "wattsmart Business Prescriptive Program (2025)", form_name: "Lighting Worksheet", form_type: "Worksheet", form_url: "https://www.rockymountainpower.net/content/dam/pcorp/documents/en/rockymountainpower/savings-energy-choices/UT_Lighting_Worksheet.pdf", version_year: 2025, is_required: true, form_notes: "Required for all lighting projects" }
  ]
};
