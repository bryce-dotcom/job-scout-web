...
OUTPUT SCHEMA (return JSON with these 6 arrays):
{"providers":[{provider_name,state,service_territory,has_rebate_program,rebate_program_url,contact_phone,notes}],"programs":[{provider_name,program_name,program_type,program_category,delivery_mechanism,business_size,dlc_required,pre_approval_required,application_required,post_inspection_required,contractor_prequalification,program_url,max_cap_percent,annual_cap_dollars,source_year,eligible_sectors:[],eligible_building_types,required_documents:[],stacking_allowed,stacking_rules,funding_status,processing_time_days,rebate_payment_method,program_notes_ai}],"incentives":[{provider_name,program_name,measure_category,measure_subcategory,fixture_category,measure_type,calc_method,rate,rate_value,rate_unit,tier,cap_percent,equipment_requirements,baseline_description,replacement_description,notes}],"prescriptive_measures":[{provider_name,program_name,measure_code,measure_name,measure_category,measure_subcategory,baseline_equipment,baseline_wattage,replacement_equipment,replacement_wattage,incentive_amount,incentive_unit,incentive_formula,max_incentive,location_type,application_type,dlc_required,dlc_tier,energy_star_required,hours_requirement,source_page,needs_pdf_upload:true,notes}],"rate_schedules":[{provider_name,schedule_name,customer_category,rate_type,rate_per_kwh,peak_rate_per_kwh,off_peak_rate_per_kwh,summer_rate_per_kwh,winter_rate_per_kwh,demand_charge,min_demand_charge,customer_charge,time_of_use,effective_date,source_url,description,notes}],"forms":[{provider_name,program_name,form_name,form_type,form_url,version_year,is_required,form_notes}]}

EXAMPLE prescriptive_measure: {"measure_code":"LT-001","measure_name":"Interior Linear T8 to LED No Controls","measure_category":"Lighting","baseline_equipment":"T8 4ft 32W 2-lamp","baseline_wattage":64,"replacement_equipment":"DLC LED 36W","replacement_wattage":36,"incentive_amount":0.60,"incentive_unit":"per_watt_reduced","incentive_formula":"(64-36) x $0.60 = $16.80","location_type":"interior","dlc_required":true,"needs_pdf_upload":true}
EXAMPLE incentive: {"measure_category":"Lighting","fixture_category":"Linear","calc_method":"Per Watt Reduced","rate":0.60,"rate_value":0.60,"rate_unit":"/watt","tier":"No Controls","equipment_requirements":"DLC 5.1+","baseline_description":"Fluorescent T8/T12"}
