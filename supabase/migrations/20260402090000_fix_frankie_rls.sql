-- Recreate collection_reminders table (first migration was rolled back)
...
-- Simple permissive policy (app uses service role for writes)
DO $$ BEGIN
  CREATE POLICY "collection_reminders_all_access"
...
-- Ensure Frankie agent exists (upsert)
